...
//
// Depot3.cpp
// Control module for Deepstar Depot 3 vessel class
//
// ==============================================================

#include "Depot3.h"

DLLCLBK VESSEL* ovcInit(OBJHANDLE hvessel, int flightmodel) { return new Depot3(hvessel, flightmodel); }

DLLCLBK void ovcExit(VESSEL* vessel) { if (vessel) delete static_cast<Depot3*>(vessel); }

void Depot3::clbkSetClassCaps(FILEHANDLE cfg)
{
	SetSize(DD_SIZE);
	...
	AddMesh("Deepstar/Depot3");	
	SetCameraOffset({ 0, -81.309, 2 });
}

void Depot3::DefineSystems()
{
	// Port dish
